// 'use client';
// import { Users, Cake, Gift, CheckCircle, Mail, Clock, LoaderPinwheel  } from 'lucide-react';
...
//   // Employees whose birthday is today but email not sent
// const pendingEmailEmployees = data?.todayBirthdays?.filter((emp: any) => {
//   const record = data?.birthdayRecords?.find(
//     (r: any) => r.employeeId === emp.id && r.year === today.getFullYear()
//   );
//   return !record?.emailSent; // Email not sent
// }) || [];


// // Employees who received email but NOT spun yet
// const notSpunEmployees = data?.todayBirthdays?.filter((emp: any) => {
//   const record = data?.birthdayRecords?.find(
//     (r: any) =>
//       r.employeeId === emp.id &&
