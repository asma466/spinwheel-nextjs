...
//     if (result?.ok) {
//       // Give NextAuth a moment to create the session
...
//       {/* Glow Orbs */}
//       <div className="absolute top-[10%] left-[15%] w-100 h-100 bg-[#CE1B22]/10 rounded-full blur-[80px] -translate-x-1/2 -translate-y-1/2 mix-blend-multiply"></div>
//       <div className="absolute bottom-[10%] right-[10%] w-125 h-125 bg-slate-500/10 rounded-full blur-[100px] translate-x-1/2 translate-y-1/2 mix-blend-multiply"></div>

//       {/* 🎡 Huge Background Spinning Wheels (Dashed Rings) */}
//       <div className="absolute w-225 h-225 border-40 border-dashed border-[#CE1B22]/5 rounded-full animate-[spin_80s_linear_infinite] pointer-events-none"></div>
//       <div className="absolute w-150 h-150 border-20 border-dashed border-slate-500/15 rounded-full animate-[spin_50s_linear_infinite_reverse] pointer-events-none"></div>
...
//         <div className="h-2 w-full bg-linear-to-r from-[#CE1B22] via-slate-500 to-[#CE1B22]"></div>
...
//             {/* Badge Indicator */}
//             <div className="px-4 py-1.5 bg-linear-to-r from-[#CE1B22]/10 to-slate-500/10 border border-[#CE1B22]/20 text-[#CE1B22] rounded-full text-xs font-bold uppercase tracking-widest flex items-center gap-2 shadow-sm">
